...
const puppeteerScraperProvider: IScraperProvider = new PuppeteerScraperProvider()

const translateTextUseCase: TranslateTextUseCase = new TranslateTextUseCase(
  puppeteerScraperProvider,
)

const translateTextController: TranslateTextController = new TranslateTextController(
